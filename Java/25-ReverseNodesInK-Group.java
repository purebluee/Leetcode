...
The problem is an extension of last problem, where now k is an input along with the linked list. 
Again, the solution needs to be in-place and only nodes itself may be changed.
